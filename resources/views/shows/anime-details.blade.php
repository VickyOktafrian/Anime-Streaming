                        ...
                        <div class="anime__details__text">
                            ...
                            <div class="anime__details__btn">
                                @auth
                                    ...
                                    @endif
                                @else
                                    <button disabled class="follow-btn"><i class="fa fa-heart-o"></i> Login to Follow</button>
                                @endauth

                                <a class="watch-btn" href="{{ route('anime.watch', ['show_id' => $show->id, 'episode_name' => $firstEpisode->episode_name]) }}">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="anime__details__sidebar">
                            ...
                            @foreach ($randomShows as $randomShow)
                                <div class="product__sidebar__view__item set-bg border border-white" data-setbg="{{ asset('assets/img/sidebar/'.$randomShow->image) }}">
                                    <h5><a href="{{ route('anime.details', $randomShow->id) }}">{{ $randomShow->name }}</a></h5>
                                </div>
                            @endforeach
                        </div>
                    </div>
